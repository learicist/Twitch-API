$(document).ready(function() {
  ...
  /*for (var i=0; i<twitchSource.length; i++) {
    for (var j=0; j<twitchSource[i].length; j++) {
      if (i[j]["stream"] === null) {
        $(".listItems").css("background-color", "#b15fc0");
      }
    }
  }*/
  /*for (var i = 0; i<twitchSource.length; i++) {
    $("#list").prepend("<li class='userData'><a href='" + twitchSource[0][1][1][i] + "'></a><h3>" + twitchSource[0][0][3][i] + "</h3></li>");
  };*/
